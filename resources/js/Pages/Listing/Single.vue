    ...
    <div class="flex flex-col-reverse md:grid grid-cols-12 gap-4 ">
        ...
        <Box class="col-span-12 md:col-span-7 flex items-center w-full ">
            <div v-if="listing.images.length" class="grid grid-cols-2 gap-1">
                <img  v-for="image in listing.images" :key="image.id" :src="image.src" alt="" class="h-150px">
            </div>
        ...
        <div class=" md:col-span-5 flex flex-col gap-4">
            ...
            <Box>
                ...
                <div>
                    <label
                        class="block w-full  p-2 rounded-md shadow-sm   dark:border-gray-600 text-gray-500">
